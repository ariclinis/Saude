                                                ...
                                                <div class="control-group">
                                                    ...
                                                    <div class="controls"> 
                                                        ...
                                                        <select class="span6 " data-placeholder="Nacionalidade" name="nacio" id="nacio" tabindex="1">
                                                            <option value="<?php echo $funcionario_dado['nacionalidade']; ?>"></option>
...
<!--                                            <div class="control-group">
                                    ...
                                    <ul class="pager wizard">
                                        ...
                                        <input class="next finish btn btn-success" type="submit" style="display:none; float:right;" value="Actualizar"/></ul></div></form>
                        </div>
                    </div>
