...
try {
    ...
    $Marcar_Consulta->setData_Registo(filter_input(INPUT_POST,'data_actual'));
    $Marcar_Consulta->setEstado_Consulta('Agendada');
   ...
   $Marcar_Consulta->setCod_Consulta($Marcar_Consulta->inserir_consulta(conexao::Chamar_conexao()));
    
    if ($Marcar_Consulta->getCod_Consulta()>0) {
        echo 'sucesso';
    } else {
        echo 'erro';
    }
